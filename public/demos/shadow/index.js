...
export function findShadowRoots(root) {
...
export function generateHTML(root, _a) {
...
export function attachDeclarativeShadowRoots(root) {
    var e_1, _a;
 ...
 */
export function setHTMLUnsafe(html) {
    this.innerHTML = html;
